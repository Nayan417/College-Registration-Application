...
public class ConformationForm extends JFrame implements ActionListener {
  ...
  JButton submitBtn, editBtn, enterBtn;
  GridBagLayout gb;
  ...
  public ConformationForm(Student student) {
    init();
      this.student = student;
    this.rollNo.setText(student.getRollNo());
...
*/
    ...
    formPanel.add(msgLab, gc);
     ...
     buttonPanel.add(submitBtn, gc); gc.gridx++;
     buttonPanel.add(editBtn, gc);
...
*/
    ...
    // Submit Button
    submitBtn = new JButton("Final Submit");
  ...
  public void actionPerformed(ActionEvent ae) {
    ...
    // For printing
    if (clickedBtn.equals("Final Submit")){
      try {
        DAO.insertData(student);
        DisplayUser dis = new DisplayUser(rollNo.getText());
        dispose();
      } catch (Exception e) {
    ...
    // For Editing 
     ...
     obj.update(student);
     //obj.rollNo.setText(rollNo.getText());
   //  obj.loginPanel.setVisible(false);
     obj.update();
    }
